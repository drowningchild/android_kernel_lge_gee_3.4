...
>>>>>>> fc26e13... intellidemand: change permission for boostpulse from root to system
{
	struct cpufreq_policy *policy;
...
>>>>>>> 286b7b0... intellidemand: give intellidemand's cpu_dbs_info its own name
...
>>>>>>> 18da3e6... intellidemand: Add support to consider other cpu load when scaling frequencies
#ifdef CONFIG_EARLYSUSPEND
